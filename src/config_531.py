...
TRAINING_MAX = {
    ...
    "bench":    90,     # 2026-03-06: 88kg×10 (e1RM ~117) + 92×3 jokers → TM 90 (conservative)
...
TM_HISTORY = {
    ...
    "bench": [
        ...
        # Recalibrated: 88kg×10 (e1RM 117) + 92×3 jokers → TM 90 (conservative)
        {"from": "2026-03-06", "base_tm": 90, "bumps_applied": 0},
    ],
    "squat": [
